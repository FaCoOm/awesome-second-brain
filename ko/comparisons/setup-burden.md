...
| [taOSmd](../solutions/taosmd.md) | PyPI 또는 source install, local embedding model, local LLM(Ollama 또는 RKLLM), data directory, 선택적 MCP/HTTP serve 설정. | Retrieval/extraction 품질은 local model과 configuration에 달려 있습니다. |
